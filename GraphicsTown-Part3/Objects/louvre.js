...
(function () {
    ...
    Louvre = function Louvre(name, position, size, color) {
        this.name = name;
        this.position = position || [0, 0, 0];
        this.size = size || 1.0;
        this.color = color || [.7, .8, .9];
    }
    Louvre.prototype.init = function (drawingState) {
    ...
    Louvre.prototype.draw = function (drawingState) {
    ...
    Louvre.prototype.center = function (drawingState) {
